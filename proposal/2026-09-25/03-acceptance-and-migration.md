...
| Stream retry/cancel | Error before commit, empty completion, abort before first chunk and mid-stream abort; delay transport delivery observation until after the provider yields a chunk | No governed chunk before qualified delivery for its attempt; bounded buffering or cancellation; late observation cannot backdate output; cancellation remains effective; no fabricated successful delivery on preflight abort |
